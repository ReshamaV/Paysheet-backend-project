...
public class DateUtil {
	...
	public static String getFormattedDateTimeStamp() {
		Format f = new SimpleDateFormat(Constants.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS);
	...
	public static Date convertStringToDate(String dateString, String format) {
		try {
			if ("dd-mm-yyyy".equalsIgnoreCase(format)) {
				return StringUtils.isEmpty(dateString) ? new SimpleDateFormat("dd-mm-yyyy").parse(dateString) : null;
			} else if ("mm-dd-yyyy".equalsIgnoreCase(format)) {
				return StringUtils.isEmpty(dateString) ? new SimpleDateFormat("mm-dd-yyyy").parse(dateString) : null;
